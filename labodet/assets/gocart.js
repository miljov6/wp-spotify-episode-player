...
var usdCurrency = function (cart_price, cart_total) {
    cart_price.forEach(item => {
        var qq = item.innerText.replace('.00','');
        qq = qq.replace(',',' ');
        item.innerText = '$' + qq;
...
var sgdCurrency = function (cart_price,cart_total){
    cart_price.forEach(item => {
        var qq = item.innerText.replace('.00','');
        qq = 'S$ ' + qq;
        item.innerText = qq;
...
var vndCurrency = function (cart_price,cart_total){
    cart_price.forEach(item => {
        var qq = item.innerText.replace('.00','');
        qq = 'VND ' + qq;
        item.innerText = qq;
...
var myrCurrency = function (cart_price,cart_total){
    cart_price.forEach(item => {
        var qq = item.innerText.replace('.00','');
        item.innerText = 'RM ' + qq;
    });
    cart_total.forEach(item => {
        var qq = item.innerText.replace('.00','');
        item.innerText = 'RM ' + qq;
...
var phpCurrency = function (cart_price,cart_total){
    cart_price.forEach(item => {
        var qq = item.innerText.replace('.00','');
        qq = '₱ ' + qq;
        item.innerText = qq;
    ...
    return function (t) {
        ...
        return __webpack_require__.m = t, __webpack_require__.c = e, __webpack_require__.d = function (t, e, r) {
            ...
            if (__webpack_require__.r(r), Object.defineProperty(r, "default", {
                enumerable: !0,
                value: t
            }), 2 & e && "string" != typeof t) for (var a in t) __webpack_require__.d(r, a, function (e) {
                return t[e]
            }.bind(null, a));
            return r
        ...
        var a = r(3), o = /^(?:submit|button|image|reset|file)$/i, n = /^(?:input|select|textarea|keygen)/i,
            i = /(\[[^\[\]]*\])/g;
                ...
                if ((e.disabled || !u.disabled) && u.name && (n.test(u.nodeName) && !o.test(u.type))) {
                    ...
                    if ("select-multiple" !== u.type) r = i(r, d, f); else {
                        ...
                        for (var h = u.options, y = !1, p = 0; p < h.length; ++p) {
                            var m = h[p], b = e.empty && !m.value, v = m.value || b;
        ...
        function readBlobAsArrayBuffer(t) {
            var e = new FileReader, r = fileReaderReady(e);
        ...
        function decode(t) {
            ...
            return t.trim().split("&").forEach((function (t) {
                if (t) {
                    var r = t.split("="), a = r.shift().replace(/\+/g, " "), o = r.join("=").replace(/\+/g, " ");
        ...
        var h = function () {
            ...
            var t, e, r;
            return t = GoCart, r = [{
                key: "removeItemAnimation", value: function (t) {
                ...
                key: "fetchCart", value: function (t) {
                    var e = this;
                    const langPath = location.pathname.split('/')[1]
                    window.fetch(`${langPath.includes('-') ? '/' + langPath : ''}/cart.js`, {credentials: "same-origin", method: "GET"}).then((function (t) {
                        return t.json()
                    })).then((function (r) {
                ...
                key: "addItemToCart", value: function (t) {
                    var e = this, r = document.querySelector("#".concat(t)), a = f()(r, {hash: !0});
                ...
                key: "changeItemQuantity", value: function (t, e) {
                    var r = this;
                    window.fetch("/cart/change.js", {
                        method: "POST",
                        credentials: "same-origin",
                ...
                key: "cartItemCount", value: function (t) {
                    this.cartCount.innerHTML = t.item_count
                    document.querySelector(".mini-cart-items-count .js-go-cart-counter").innerHTML = t.item_count;
                    document.querySelector("#cartText_m").innerHTML = t.item_count;
                    document.querySelector("#cart_icon_svg").removeAttribute("class");
                    document.querySelector("#cart_icon_svg").classList.add("cart_qty_"+t.item_count);
                    document.querySelector("#cart_icon_svg_m").removeAttribute("class");
                    document.querySelector("#cart_icon_svg_m").classList.add("cart_qty_"+t.item_count);
                }
            }, {
                key: "fetchAndOpenCart", value: function () {
                    var t = this;
                ...
                key: "fetchAndOpenModal", value: function (t) {
                    var e = this;
                    this.fetchCart((function () {
                ...
                key: "fetchHandler", value: function (t, e) {
                ...
                key: "addItemToCartHandler", value: function (t) {
                    return this.displayModal ? this.fetchAndOpenModal(t) : this.fetchAndOpenCart()
                }
            }, {
                key: "ajaxRequestFail", value: function () {
                    this.openFailModal(), this.openCartOverlay()
                }
            }, {
                key: "renderCartModal", value: function (t) {
                    this.clearCartModal();
                ...
                key: "renderDrawerCart", value: async function (t) {
                    var e = this;
                    // if (!e.rates) {
                    // let cartPrices = document.querySelector('#cartItemsPrice').innerHTML
                    // let totalPrice = await fetch('/en-ua/cart?view=prices')
                    // totalPrice = await totalPrice.text()
                    // totalPrice = parseInt(totalPrice)
                    // e.rates = totalPrice / t.total_price
                    // }
                    this.clearCartDrawer(), t.items.forEach((function (t, r) {
                        var a = t.variant_title;
                        var b = t.variant_options;
              			var metalware = t.variant_options[1];
              			var coloroption = t.variant_options[0];
                        console.log('prop are' + t.properties);
                        if(t.properties === null){
							var newrtitle = t.product_title;
               				var devicename = '';
           				} else {
                              for (let property in t.properties) {
                                if (property == 'Device name'){
                                    var devicename = '<div class="go-cart-item__variant devicename">Device: <span>' + t.properties[property] + '</span></div>';
                                    var newrtitle = t.product_title.replace(t.properties[property], '');
                                } else {
                                    var devicename = '';
                                    var newrtitle = t.product_title;
                                }
       ...
       if (newrtitle === undefined){
       	newrtitle = t.product_title;
       var devicename = '';
       }               
                        if (coloroption.indexOf('Default Title') >= 0){
							var colorspan = '';
           				} else {
                      		var colorspan = '<div class="go-cart-item__variant colorcart">Color: <span>' + coloroption + '</span></div>';
                        }
                        if (metalware == null){
							var metalwarespan = '';
              			
            			} else{	
                      		var metalwarespan = '<div class="go-cart-item__variant metalwarecart">Metalware: <span>'+ metalware +'</span></div>' 
                        }
                      	var testvar = '<h1>Test 2</h1>';
                        null === a && (a = "");
                        var o = '\n        ' +
                            '<div class="go-cart-item__single" data-line="'.concat(Number(r + 1), '">\n            ' +
                                ...
                                '<div class="go-cart-item__image" style="background-image: url(').concat(t.image, ');"></div>\n                ' +
                                '<div class="go-cart-item__info">\n                    ' +
                                '<a href="').concat(t.url, '" class="go-cart-item__title">').concat(newrtitle, '</a>\n    ' +
                                devicename +
                                colorspan +
                               metalwarespan +
                    ...
                    let current_currency = document.querySelector("#currentCurrency").getAttribute('data-currency'),
                        cart_price = document.querySelectorAll(".go-cart-item__price"),
                        cart_total = document.querySelectorAll(".js-go-cart-drawer-subtotal");
                    switch (current_currency) {
                        case 'EUR':
                            eurCurrency(cart_price,cart_total);
                            break;
                      	case 'USD':
                            usdCurrency(cart_price,cart_total);
                            break;
                        case 'GBP':
                            gbpCurrency(cart_price,cart_total);
                            break;
                        case 'CAD':
                            cadCurrency(cart_price,cart_total);
                            break;
                        case 'AED':
                            aedCurrency(cart_price,cart_total);
                            break;
                        case 'JPY':
                            jpyCurrency(cart_price,cart_total);
                            break;
                        case 'KRW':
                            krwCurrency(cart_price,cart_total);
                            break;
                        case 'QAR':
                            qarCurrency(cart_price,cart_total);
                            break;
                        case 'SAR':
                            sarCurrency(cart_price,cart_total);
                            break;
                        case 'HKD':
                            hkdCurrency(cart_price,cart_total);
                            break;
                        case 'MXN':
                            mxnCurrency(cart_price,cart_total);
                            break;
                        case 'THB':
                            thbCurrency(cart_price,cart_total);
                            break;
                        case 'TWD':
                            twdCurrency(cart_price,cart_total);
                            break;
                        case 'AUD':
                            audCurrency(cart_price,cart_total);
                            break;
                        case 'CHF':
                            chfCurrency(cart_price,cart_total);
                            break;
                        case 'SGD':
                            audCurrency(cart_price,cart_total);
                            break;
                        case 'VND':
                            ...
                            break;
                        case 'KHR':
                            khrCurrency(cart_price,cart_total);
                            break;
                        case 'ILS':
                            audCurrency(cart_price,cart_total);
                            break;
                        case 'CZK':
                            czkCurrency(cart_price,cart_total);
                            break;
                        case 'RON':
                            ronCurrency(cart_price,cart_total);
                            break;
                        case 'BRL':
                            brlCurrency(cart_price,cart_total);
                            break;
                        case 'TRY':
                            tryCurrency(cart_price,cart_total);
                            break;
                        case 'MYR':
                            myrCurrency(cart_price,cart_total);
                            break;
                        case 'INR':
                            inrCurrency(cart_price,cart_total);
                            break;
                        case 'RUB':
                            rubCurrency(cart_price,cart_total);
                            break;

                        case 'UAH':
                            uahCurrency(cart_price,cart_total);
                            break;
                        ...
                        case 'PLN':
                            plnCurrency(cart_price,cart_total);
                            break;
                        case 'DKK':
                            dkkCurrency(cart_price,cart_total);
                            break;
                        case 'PHP':
                            phpCurrency(cart_price,cart_total);
                            break;
                        case 'BGN':
                            bgnCurrency(cart_price,cart_total);
                            break;
                        case 'EGP':
                            egpCurrency(cart_price,cart_total);
                            break;
                        case 'SEK':
                            sekCurrency(cart_price,cart_total);
                            break;
                        case 'AZN':
                            aznCurrency(cart_price,cart_total);
                            break;
                ...
                key: "renderMiniCart", value: function (t) {
                    var e = this;
                ...
                key: "renderBlankCartDrawer", value: function () {
                ...
                key: "renderBlankMiniCart", value: function () {
